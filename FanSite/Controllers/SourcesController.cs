...
namespace FanSite.Controllers
{
    public class SourcesController : Controller
    {
        ...
        {
            if (StoryRepository.physical.Count != 2)
            {
                ...
                StoryRepository.physical.Add(b);
                StoryRepository.physical.Add(a);

                List<PhysicalMediaModel> physicals = StoryRepository.physical;
        ...
        {
            if (StoryRepository.online.Count != 2)
            {
                ...
                StoryRepository.online.Add(b);
                StoryRepository.online.Add(a);

                List<OnlineMediaModel> onlines = StoryRepository.online;
